        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li><a href="#search" className="hover:text-emerald-700">Search</a></li>
              <li><a href="#features" className="hover:text-emerald-700">Features</a></li>
              <li><a href="#legal" className="hover:text-emerald-700">Legal Center</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-4">Legal</h4>
            <ul className="space-y-2 text-sm text-slate-500">
              <li><a href="#privacy-policy" className="hover:text-emerald-700">Privacy Policy</a></li>
              <li><a href="#terms-of-service" className="hover:text-emerald-700">Terms and Conditions</a></li>
              <li><a href="#disclaimer-policy" className="hover:text-emerald-700">Disclaimer</a></li>
            </ul>
          </div>
        </div>
      </div>
